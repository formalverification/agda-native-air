-- Surjective-surjinv-inverse-r.agda (gold solution)
--
-- File: data/benchmarks/agda-algebras-v0/gold/Surjective-surjinv-inverse-r.agda
--
-- Gold solution for benchmark obligation: algebras-surjective-surjinv-inverse-r
--
