-- Nat-plus-mono-lt-diag.agda (gold solution)
--
-- File: data/benchmarks/agda-stdlib-haystack-v0/gold/Nat-plus-mono-lt-diag.agda
--
...
+-mono-<-diag lt = Data.Nat.Properties.+-mono-< lt lt
