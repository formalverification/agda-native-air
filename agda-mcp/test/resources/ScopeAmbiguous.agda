...
--
-- Description:
--   Fixture for resolve_name acceptance moment: `amb` is in scope twice
--   (once from each of two opened modules) so a resolution query must report
--   two candidates, each with its own provenance chain.
--
