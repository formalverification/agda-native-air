...
| 12 | Target exclusion by name and normalised statement, NAMED in reports, with a labeled off-switch control | Adopted (P2) | Control run commits all five admitted targets (10/22 vs 5/22); RetrieveSpec |
