...
Thus the new role of the ProofParser Scala/Spark code is merely to drive the Haskell
...
At the time of this writing, all other programs in the `proof-parser` subproject are
...
(See also the instructions in `agda-backend-jsonl/README.md`.) 
