#!/usr/bin/env python3
"""
gh_project_populate.py — Create GitHub milestones, labels, and issues from a
structured Markdown project plan.
...
def _parse_labels(text: str) -> list[Label]:
    """Extract labels from the script section, or use defaults."""
    ...
    defaults = [
        ...
        Label("research",       "5319e7", "Research mathematics"),
        ...
        Label("meta",           "ededed", "Project meta / process"),
        Label("reproducibility","1d76db", "Reproducibility and dev workflow"),
    ]
    return defaults
